...
const Navbar = () => {
  ...
  return (
    <div className="w-full flex flex-col md:flex-row lg:flex-row xl:flex-row 2xl:flex-row border-2">
      <div className="flex justify-between items-center">
        <h1 className="text-4xl font-sans font-extrabold underline m-1 mx-8" ><Link to="/">SuperStore</Link></h1>
        <button onClick={() => setIsOpen(!isOpen)} className="sm:hidden mx-3">
      ...
      <nav className={`w-full ${isOpen ? 'block' : 'hidden'} sm:block`}>
        <ul className="flex flex-col sm:flex-row 	sm:p-3 2xl:p-0 2xl:m-0 sm:justify-start 2xl:justify-evenly 2xl:items-center xl:items-center lg:items-center md:items-center  lg:justify-evenly md:justify-evenly  bg-white sm:h-14 ">
