...
const Login = () => {
    ...
    <div className='flex flex-col justify-center items-center gap-4 rounded-xl shadow-xl border-2 p-5 w-full sm:w-3/4 md:w-1/2 lg:w-1/3 xl:w-1/4'>
        <div className=''>
        ...
        <p className=' font-serif cursor-pointer font-normal underline'><Link to='/signup' >Forgot Password ?</Link></p>
